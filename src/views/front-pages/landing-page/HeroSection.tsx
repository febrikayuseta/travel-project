    ...
    <section id='home' className='relative overflow-hidden pbs-[70px] -mbs-[70px] bg-backgroundPaper z-[1]'>
      ...
      <div className={classnames('pbs-16 overflow-hidden', frontCommonStyles.layoutSpacing)}>
        <motion.div
          ...
          className='md:max-is-[550px] mlb-0 mli-auto text-center'
        >
          <Typography className='font-extrabold text-primary sm:text-[38px] text-3xl mbe-4 leading-[44px]'>
            Explore, Play, and Discover the World with TravelYuk 🌏
          </Typography>
          <Typography className='font-medium' color='text.primary'>
            Your premier destination for exclusive playhouse tickets, playground fun, and unforgettable tours. Start your journey with ease.
          </Typography>
          <div className='mlb-8'>
            <Button
              component={Link}
